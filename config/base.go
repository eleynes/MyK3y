...
import (
	...
	"github.com/eleynes/MyK3y/constants"
)
...
type Config struct {
	...
	// RedisReset:                 false,
	// RedisTLSConfig:             nil,
	// RedisPoolSize:              10 * runtime.GOMAXPROCS(0),
	// RedisAddrs:                 []string{},
	// RedisMasterName:            "",
	// RedisClientName:            "",
...
func New() (*Config, error) {
	...
	enableCache := vars.mandatoryBool("ENABLE_CACHE")
	redisHost := vars.mandatory("REDIS_HOST")
	redisPort := vars.mandatoryInt("REDIS_PORT")
	redisUsername := vars.mandatory("REDIS_USERNAME")
	redisPassword := vars.mandatory("REDIS_PASSWORD")
	redisURL := vars.mandatory("REDIS_URL")
	redisDatabase := vars.mandatoryInt("REDIS_DATABASE")
